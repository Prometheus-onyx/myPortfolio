...
export default function ContactPage() {
  const emessage =
    "Hi Steve, I found your portfolio and would like to get in touch.";
  ...
  const handleSubmit = (e) => {
    ...
    const text = `*Project Proposal Enquiry*
    *Name:* ${name}
    *Email:* ${email}
    *Phone:* ${phone}
    *Subject:* ${subject}
      ...
      <div>
        ...
        >
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <form onSubmit={handleSubmit} className="rounded-[2rem] border border-white/10 bg-zinc-900/70 p-6">
              ...
              <button type="submit" className="mt-6 inline-flex items-center gap-2 rounded-full bg-emerald-500 px-5 py-3 font-medium text-zinc-950">
            ...
            <div className="space-y-6">
              <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6">
                ...
                <div className="mt-4 space-y-3 text-zinc-300">
                  ...
                  <a
                    className="flex items-center gap-3"
                    href={`https://mail.google.com/mail/?view=cm&fs=1&to=stevebickookumu%40gmail.com&su=${encodeURIComponent("Project Proposal Enquiry")}&body=${encodeURIComponent(emessage)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Mail size={18} />
